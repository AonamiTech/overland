    ...
    >
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="space-y-3">
              ...
              <p className="text-[#3E3F46]">Create a new load posting to receive competitive bids from verified transporters</p>
            </div>

            <div className="flex items-center space-x-3">
              <Badge variant="outline" className="flex items-center space-x-1 border-[#E7E3DC] text-[#5B6470] bg-white">
                <Clock className="w-3 h-3" />
                <span>Auto-saved 30s ago</span>
              </Badge>
              {formData.loadId && (
                <Badge className="bg-[rgba(15,122,74,0.08)] text-[#0F7A4A] border-[rgba(15,122,74,0.2)]">
        ...
        <Card className="ov-card">
          <div className="p-6">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 rounded-full flex items-center justify-center bg-[rgba(14,50,232,0.08)]">
                <Clock className="w-5 h-5 text-[#0E32E8]" />
              </div>
              <div>
                <h3 className="font-semibold text-[#14161A]">Expected Timeline</h3>
                <p className="text-[#3E3F46] text-sm">You'll start receiving competitive bids within ~12 minutes of posting</p>
              </div>
            </div>
          </div>
        </Card>
